...
const Home = () => {
  ...
  <div className="bg-light p-5 rounded">
    ...
    <a className="btn btn-lg btn-primary" href="Docs" >More information and realted blogs <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-flower1" viewBox="0 0 16 16">
