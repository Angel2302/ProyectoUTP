  ...
  return (
    ...
    <div>
      ...
      <div className="row justify-content-center mx-auto">
          <a className="col-sm bg-success text-light">
            <h4>
              <Link to="/products/tools" ><svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-tools" width="84" height="84" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#ffffff" fill="none" strokeLinecap="round" strokeLinejoin="round">
          ...
          <a className="col-sm bg-success text-light">
            <h4>
              ...
              </svg><h4 className="text-light">Plants</h4></Link>
            </h4>
          </a>
      </div>
    </div>
