                                                                                                                            ...
                                                                                                                            <table cellspacing="0" cellpadding="0">
                                                                                                                                <tr>
                                                                                                                                    <td style="font-family: Geneva, Tahoma, Verdana, sans-serif; font-size: 16px; line-height: 22px; color: #555555; padding-top: 16px;" align="left">
                                                                                                                                        El siguiente correo se ha generado automaticamente desde el sitio web <a href="http://localhost:3000/" style="text-decoration: none;">The Green List</a>                                                                                                    con el fin de ayudarlo en su proceso de restablecimiento de contraseña. A continuación ba a encontrar un boton que lo va a direccionar a la pagina donde
                                                                                                                                        podrá ingresar una nueva contraseña.<br><br> Si presenta problemas para abrir el enlace del boton, copie el siguiente elnace en el navegador:<br><br>
